...
class ObsManager(ObsManagerBase):
    ...
    def get_observation(self):
        ...
        # CARLA 0.9.15 https://github.com/carla-simulator/carla/issues/6216
        vehicle_bbox_list = self._world.get_level_bbs(carla.CityObjectLabel.Car) + self._world.get_level_bbs(carla.CityObjectLabel.Bicycle) + self._world.get_level_bbs(carla.CityObjectLabel.Bus) + self._world.get_level_bbs(carla.CityObjectLabel.Motorcycle) + self._world.get_level_bbs(carla.CityObjectLabel.Rider) + self._world.get_level_bbs(carla.CityObjectLabel.Train) + self._world.get_level_bbs(carla.CityObjectLabel.Truck)
        # CARLA 0.9.11

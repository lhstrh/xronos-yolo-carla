...
class YoloAgent(Node):
    ...
    def __init__(self):
        ...
        print("======== Yolo Agent Pubsub Shared Memory Start ========")
        ...
        self.timelogger = TimeLogger(warmup_steps = cfg.warmup_steps, total_steps = cfg.total_steps, name="ros2_shm_yolo", save_dir=hydra_dir + "/time")
        print("======== Yolo Agent Pubsub Shared Memory Ready ========")

    def listener_callback(self, msg):
        img = self.seri.deserialize(pickle.loads(b''.join(msg.data)))
        ...
        if cfg.log_video:
            ...
            if(self.count == 0):
                ...
                yolo_path = hydra_dir + "/videos/ros2_yolo_shm.mp4"
            ...
            cv2.putText(frame_bgr, f"ROS2 Shared Memory", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)

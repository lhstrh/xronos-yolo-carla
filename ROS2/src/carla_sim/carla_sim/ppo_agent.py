...
class PPOAgent(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            ...
            10)
        agent_start()
        self.timelogger = TimeLogger(warmup_steps = cfg.warmup_steps, total_steps = cfg.total_steps, name="ros2_s_agent", save_dir=hydra_dir + "/time")
        print("======== PPO Agent Pubsub Ready ========")
    
    def listener_callback(self, msg):
        agent_obs = pickle.loads(b''.join(msg.data))
